...
/* ---------- 全局状态 ---------- */
const APP_VERSION = '1.0.302';   // v1.0.302 节拍表防串位：splitBeatsTextBlocks 不再把「===== 第N+1章 =====」分隔行吞进上一章 beatsText；阅读渲染/L1当前章/L2上一章注入前统一过 cleanBeatDividerTrailer 兜底历史脏数据，杜绝正文 AI 误判章节边界。完整版本日志见 /workspace/CHANGELOG.md；历史版本注释已从源码迁移至该文件，保持本行精简。
