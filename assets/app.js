...
5. 必须使用实体：本章要落到文中的人名/地名/专名（优先取自设定词典；本章确需新增的配角/路人/地名/专名一并纳入，并在底部【本章实体清单】统一登记）。
...
3. 必须使用实体可取自设定词典；确需引入词典外的下位配角/路人/地名/专名以丰满本章时，允许适度新增（主角/核心反派/核心地域的绝对核心名仍禁止乱加），所增新名一律登记到本块【本章实体清单】供词典充实收编。
